...
class PromoPageLocators():
    ...
    BOOK_IN_BASKET_NAME = (By.XPATH, "//div[contains(@class, 'alertinner') and contains(., 'был добавлен в вашу корзину')]//strong")
    BOOK_PRICE_IN_BASKET = (By.XPATH, "//div[@class='alertinner ']//*[contains(text(), 'Стоимость корзины теперь составляет')]//strong")
